...
public class WordCounter {
    public static void main(String[] args) {
        ...
        String[] words = text.split("[\\s\\p{Punct}]+"); // Split the text into words using space or punctuation as delimiters.
        int wordCount = words.length;

        System.out.println("Total number of words: " + wordCount);

        // Optional: Implement ignoring common words or stop words.
        Set<String> stopWords = new HashSet<>(Arrays.asList("the", "and", "is", "in", "it", "of", "a", "an")); // Add more stop words as needed.
